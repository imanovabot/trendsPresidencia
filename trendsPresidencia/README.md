...
- ✅ **Botón de refrescar** — Actualiza datos manualmente desde APIs
- ✅ **Auto-refresh** — Se actualiza automáticamente cada 30 minutos (configurable)
...
- Requiere API keys para datos en tiempo real (YouTube, HuggingFace, etc.)
- TikTok, X, Instagram necesitan APIs configuradas (actualmente devuelven 0)
- Sin autenticación
- Los datos se cachean en memoria (reiniciar el servidor limpia caché)
